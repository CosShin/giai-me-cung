...
bool isMazeMode = true; // Start with maze-solving mode
...
void loop() {
  ...
  // Add conditions to switch between modes
  if (digitalRead(SWITCH_PIN)) {
    isMazeMode = !isMazeMode; // Toggle mode
    delay(1000); // Delay to prevent rapid mode changes due to button press
  }
}
